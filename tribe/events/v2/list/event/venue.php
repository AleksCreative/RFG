...
?>
<address class="event-location-data">
	<img src="<?php echo get_theme_file_uri( 'img/location-icon.png' ); ?>" alt="location icon" >
	<p class="event-box-venue-title">
		<?php echo wp_kses_post( $venue->post_title ); ?>
	</p>
	<p class="event-box-venue-address">
		<?php
