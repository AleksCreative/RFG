...
<div class="tribe-events-meta-group tribe-events-meta-group-details">
	<h3 class="tribe-events-single-section-title"><strong><?php esc_html_e( 'Event details', 'the-events-calendar' ); ?></strong></h3>
	<dl>
		...
		if ( tribe_event_is_all_day() && tribe_event_is_multiday() ) :
			...
			<p class="tribe-events-start-date-label"> <?php esc_html_e( 'Event start:', 'the-events-calendar' ); ?> 
			<span>
			...
			<p class="tribe-events-end-date-label"> <?php esc_html_e( 'Event end:', 'the-events-calendar' ); ?>
			<span>
		...
		elseif ( tribe_event_is_all_day() ):
			...
			<p class="tribe-events-start-date-label"> <?php esc_html_e( 'Date:', 'the-events-calendar' ); ?> 
			<span>
				<abbr class="tribe-events-abbr tribe-events-start-date published dtstart" title="<?php echo esc_attr( $start_ts ); ?>"> <?php echo esc_html( $start_date ); ?> </abbr>
			</span></p>
		...
		elseif ( tribe_event_is_multiday() ) :
			...
			<p class="tribe-events-start-datetime-label"> <?php esc_html_e( 'Event start:  ', 'the-events-calendar' ); ?>
				<span>
			...
			<p class="tribe-events-end-datetime-label"> <?php esc_html_e( 'Event end:', 'the-events-calendar' ); ?>
				<span>
		...
		// Single day events
			...
			<p class="tribe-events-start-date-label"> <?php esc_html_e( 'Date:', 'the-events-calendar' ); ?>
				<span class="tribe-events-abbr tribe-events-start-date published dtstart" title="<?php echo esc_attr( $start_ts ); ?>"> <?php echo esc_html( $start_date ); ?>
				</span>
			</p>
			...
			<p class="tribe-events-start-time-label"> <?php echo esc_html( $time_title ); ?> 
			<span class="tribe-events-abbr tribe-events-start-time published dtstart" title="<?php echo esc_attr( $end_ts ); ?>">
		...
		if ( ! empty( $cost ) ) : ?>
			...
			<p class="tribe-events-event-cost-label"> <?php esc_html_e( 'Tickets:  ', 'the-events-calendar' ); ?> 
			<span class="ticket-price-cost"><?php echo esc_html( $cost ); ?></span></p></div>
		<?php endif ?>
